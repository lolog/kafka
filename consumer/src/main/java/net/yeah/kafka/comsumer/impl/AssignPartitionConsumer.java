 ...
 * @author lolog
 */
public class AssignPartitionConsumer implements net.yeah.kafka.comsumer.KafkaConsumer {
	...
	public AssignPartitionConsumer(String brokers, List<Map<String, String>> topics, String group) {
