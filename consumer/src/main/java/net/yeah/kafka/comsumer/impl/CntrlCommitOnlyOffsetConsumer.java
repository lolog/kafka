 ...
 *
 */
public class CntrlCommitOnlyOffsetConsumer implements net.yeah.kafka.comsumer.KafkaConsumer {
	...
	public CntrlCommitOnlyOffsetConsumer(String brokers, List<String> topics, String group) {
